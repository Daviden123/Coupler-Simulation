...
eq1 = (V1 - Vin) / Z0 + (V1 - V3) / (-X*1j) + (V1 - V2) / Z_L + V1/Z_C == 0;
eq2 = (V2 - V1) / Z_L + (V2) / Z_C + (V2-V4) / (-X*1j) + V2 / Z0 == 0;
eq3 = (V3) / Z0 + (V3 - V1) / (-X*1j) + (V3 - V4) / Z_L + V3/Z_C == 0;
eq4 = (V4 - V3) / Z_L + (V4) / Z_C + (V4-V2) / (-X*1j) + V4 / Z0 == 0;
